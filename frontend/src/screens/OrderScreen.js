    ...
    <div>
      ...
      <Row>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              {order.isDelivered ? (
                ...
                <MessageBox variant="danger">Не оформлен заказ</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Способы:</strong> {order.paymentMethod}
              </Card.Text>
              {order.isPaid ? (
                <MessageBox variant="success">
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Общая стоимость заказа</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Items</Col>
